# PainterVideoCombine2
#
# 与 PainterVideoCombine 完全一致的后端逻辑，只是单独注册成一个新节点。
# 前端（web/js/PainterVideoCombine2.js）在第一行（images 行）右侧额外绘制
# 「同步预览」「同步暂停」两个按钮。
...
NODE_CLASS_MAPPINGS = {
    "PainterVideoCombine2": PainterVideoCombine2
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "PainterVideoCombine2": "Painter Video Combine 2"
}
